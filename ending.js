document.addEventListener("DOMContentLoaded", function() {
  ...
  var loveForCornell = document.getElementById("loveForCornell"); // Changed from loveForColumbia
  fadeInOut(loveForCornell, 1000, 8000);
  ...
  var cornellText = document.getElementById("cornellText"); // Changed from columbiaText
  setTimeout(function() {
    cornellText.style.display = "block";
    fadeInOut(cornellText, 1000, 5000);
  }, 15000);
